...
For Unix:
```
conda create --name judge python=3.10 -y
...
The **Malvern-Hills** dataset (with cropped lines and metadata) can be downloaded [here](https://judgeocr.s3.eu-north-1.amazonaws.com/malvern_hills_trust_updated.zip).
...
- `notebooks/00_{iam, malvern_hills, bentham, casia}_preprocessing.py`: run OCR engines on the datasets, save to pandas dataframes, produce multi-page datasets and save dataframes for downstream notebooks to .pkl files
...
python notebooks/00_casia_preprocessing.py
...
python notebooks/01_experiments.py task iam_multipage_exactpages=05 model gemma-3-27b-it
python notebooks/01_experiments.py task iam_multipage_exactpages=05 model gpt-4o
python notebooks/01_experiments.py task iam_multipage_exactpages=05 model gemini-2.5-pro
python notebooks/01_experiments.py task iam_multipage_random_exactpages=05 model gemma-3-27b-it
python notebooks/01_experiments.py task iam_multipage_random_exactpages=05 model gpt-4o
python notebooks/01_experiments.py task iam_multipage_random_exactpages=05 model gemini-2.5-pro
## MHills
...
python notebooks/01_experiments.py task malvern_hills_multipage_min_5p model gemma-3-27b-it
python notebooks/01_experiments.py task malvern_hills_multipage_min_5p model gpt-4o
python notebooks/01_experiments.py task malvern_hills_multipage_min_5p model gemini-2.5-pro
python notebooks/01_experiments.py task malvern_hills_multipage_min_10p model gpt-4o
python notebooks/01_experiments.py task malvern_hills_multipage_min_10p model gemini-2.5-pro
## Bentham
...
## CASIA
python notebooks/01_experiments.py task casia_multipage model gpt-4o
python notebooks/01_experiments.py task casia_multipage model gemini-2.5-pro
